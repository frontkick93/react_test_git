...
import Displayform1 from './Displayform1';
import Mui from './Mui';
  ...
  return (
    <>
      <nav>
        ...
        <ul id="navbar">
          { /* <li><a className="active" href="Test" >Testing</a></li> */}
    
          <li><Link to="/">MyHome</Link></li>
          <li><Link to="/powerbi1">Powerbi1</Link></li>
          <li><Link to="/powerbi2">Powerbi2</Link></li>
          <li><Link to="/Form1">Form1</Link></li>
          <li><Link to="/Displayform1">Displayform1</Link></li>
          <li><Link to="/Mui">Mui</Link></li>
          <li><Link to="/Mydata">Mydata</Link></li>
      ...
      <Routes>
        {/*<Route path="/Test" element={<MyHome />} /> */}
        <Route path ="/Form1" element={<Form1 />} />
        <Route path="/" element={<Myhome />} />
        <Route path="/powerbi1" element={<Header />} />
        <Route path="/powerbi2" element={<Header2 />} />
        <Route path="/DisplayForm1" element={<Displayform1 />} />
