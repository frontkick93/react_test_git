    ...
    render() {
        return (
            <nav>
                ...
                <div id="mobile" onClick={this.handleClick}> <i className='fas fa-bars' ></i></div>
                <div id="mobile" onClick={this.handleClick}>
                    <i id="bar" className=
                        {this.state.clicked ? 'fas fa-times' : 'fa fas-bars'}></i>
                </div>
